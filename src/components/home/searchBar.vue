<template>
  <div class="search-bar-wrapper">
    <div class="title-search-wrapper" ref="titleSearchWrapper"><!-- :class="{'show-search': ifShowSearchPage, 'hide-shadow': ifHideShadow}" -->
    ...
    <transition name="host-search">
      <div class="hot-search-wrapper" ref="searchMaskWrapper"><!--  v-if="ifShowSearchPage && ifShowHotSearch" -->
